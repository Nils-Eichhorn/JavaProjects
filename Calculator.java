...
public class Calculator implements ActionListener{
	...
	Calculator(){
		...
		frame.setSize(420, 550);	// (x,y)
		frame.setLayout(null);
		
		textfield = new JTextField();
		textfield.setBounds(50, 25, 300, 50); 	// null Layout --> set the size of the textfield manually
												// (x, y, width, height)
	...
	public void actionPerformed(ActionEvent e) {
		...
		// pressing the (-) button first will result in an exception I am, as of now, too dumb to understand how to fix
		}
